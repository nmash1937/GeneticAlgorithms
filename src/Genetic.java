...
public class Genetic {
	//Constants
	public static int POP_SIZE = 8; //Must be even number to pair parents
	public static int FITNESS_ONE_IN =10;//9999
	...
	public double fitness(String a) {
		int x = toInt(a);
		return Math.sin(Math.PI*x/256)*FITNESS_ONE_IN;
	}
